        ...
        <div class="ibox-content">
            <form class="form-horizontal m-t" id="roleAddForm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="productName" name="productName"  value="${product.productName}" class="form-control" type="text">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="productTitle" name="productTitle" value="${product.productTitle}" class="form-control" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">企业类型：</label>
                    <div class="col-sm-8">
                            <form:select path="product.comType" cssClass="form-control">
                                <form:option value="" label="--请选择--"></form:option>
                                <form:options items="${companyTypeList}" itemValue="code" itemLabel="value"/>
                            </form:select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <form:select path="product.subComType" cssClass="form-control">
                            <form:option value="" label="--请选择--"></form:option>
                            <form:options items="${companySizeList}" itemValue="code" itemLabel="value"/>
                        </form:select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <form:select path="product.monthSize" cssClass="form-control">
                            <form:option value="" label="--请选择--"></form:option>
                            <form:options items="${monthSizeList}" itemValue="code" itemLabel="value"/>
                        </form:select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="price" name="price" value="${product.price}" class="form-control" type="number">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">备注：</label>
                    <div class="col-sm-8">
                        <input id="remark" name="remark" value="${product.remark}" class="form-control" type="text">
                    </div>
                </div>
