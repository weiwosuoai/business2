...
<div class="wrapper wrapper-content">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form class="form-horizontal m-t" id="myform" method="post" enctype="multipart/form-data" action="/sys/product/desc/add">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="productDesc" name="productDesc" class="form-control" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">所需材料：</label>
                    <div class="col-sm-8">
                        <input id="needPapers" name="needPapers" class="form-control" type="text">
                    </div>
                </div>
                <div class="form-group">
