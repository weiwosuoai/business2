        ...
        <div class="ibox-content">
            ...
            <div role="form" class="form-inline">
                <div class="form-group">
                    <label class="margin-right-5px">服务名称：</label>
                    <input type="text" id="descName" name="descName" class="form-control">
                </div>
...
<script type="text/javascript">
    ...
    $('#table').bootstrapTable({
        ...
        uniqueId: 'descId',
        method: 'get',
        url: '/sys/product/desc/list/data',
        dataType: 'json',
        ...
        columns: [{
            ...
            formatter: function(value, row, index) {
                return "<a href='/file/download?filePath=" + value + "'>" + value + "</a>";
            }
        }, {
            field: 'remark',
            title: '备注'
    ...
    $('#add').click(function(){
        layer.open({
            ...
            area: ['800px', '500px'],
            content: '<%=context%>/sys/product/desc/add/view',
            end: function() {
                // iframe 层提交表单返回的状态码
    ...
    $('#edit').click(function(){
        ...
        if (a.length == 1) {
            ...
            layer.open({
                ...
                maxmin: true, //开启最大化最小化按钮
                area: ['800px', '500px'],
                content: "<%=context%>/sys/product/desc/" + id + "/edit/view",
                end: function() {
                    // iframe 层提交表单返回的状态码
                    var status = $("#layer_status").val();
                    // iframe 层提交表单返回的服务器响应的消息
        ...
        if (a.length == 1) {
            ...
            layer.confirm('是否确定要删除这条记录？', {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "<%=context%>/sys/product/desc/" + id + "/delete",
